...
struct Recipe: Identifiable {
    ...
    //Init for creating recipes by users
    init() {
    ...
    func index(of direction: Direction, exludingOptionalDirection: Bool) -> Int? {
        let directions = directions.filter {
            exludingOptionalDirection ? !$0.isOptional : true
        }
  ...
  static let testRecipes: [Recipe] = [
    Recipe(mainInformation: MainInformation(name: "Dad's Mashed Potatoes",
           ...
           ingredients: [
            ...
            Ingredient(name: "Butter", quantity: 1, unit: .tablespoons),
            Ingredient(name: "Milk", quantity: 0.5, unit: .cups),
            Ingredient(name: "Salt", quantity: 2, unit: .teaspoons)
           ],
           directions:  [
    ...
    Recipe(mainInformation: MainInformation(name: "Beet and Apple Salad",
           ...
           ingredients: [
            ...
            Ingredient(name: "Lemon zest", quantity: 0.5, unit: .tablespoons),
            Ingredient(name: "Lemon juice", quantity: 1.5, unit: .tablespoons),
            Ingredient(name: "Olive Oil", quantity: 1, unit: .teaspoons),
    ...
    Recipe(mainInformation: MainInformation(name: "Braised Beef Brisket",
           ...
           ingredients: [
            ...
            Ingredient(name: "Caul, Duck, or Chicken Fat", quantity: 3, unit: .tablespoons),
    ...
    Recipe(mainInformation: MainInformation(name: "Best Brownies Ever",
           ...
           ingredients: [
            ...
            Ingredient(name: "Vanilla Extract", quantity: 1, unit: .teaspoons),
            Ingredient(name: "Milk", quantity: 2, unit: .tablespoons)
           ],
           directions:  [
    ...
    Recipe(mainInformation: MainInformation(name: "Omelet and Greens",
                                            ...
                                            category: .breakfast),
           ingredients: [
            Ingredient(name: "Olive Oil", quantity: 3, unit: .tablespoons),
            ...
            Ingredient(name: "Unsalted Butter", quantity: 2, unit: .tablespoons),
    ...
    Recipe(mainInformation: MainInformation(name: "Vegetarian Chili",
           ...
           ingredients: [
            ...
            Ingredient(name: "Tomato Paste", quantity: 2, unit: .tablespoons),
            ...
            Ingredient(name: "Chili Powder", quantity: 2, unit: .tablespoons),
            Ingredient(name: "Cumin", quantity: 1, unit: .tablespoons),
            Ingredient(name: "Oregano", quantity: 2, unit: .teaspoons),
            Ingredient(name: "Kosher Salt", quantity: 1, unit: .none),
    ...
    Recipe(mainInformation: MainInformation(name: "Classic Shrimp Scampi",
           ...
           ingredients: [
            ...
            Ingredient(name: "Red pepper flakes", quantity: 0.5, unit: .teaspoons),
            Ingredient(name: "White Wine", quantity: 0.33, unit: .cups),
            Ingredient(name: "Lemons Squeezed + Wedges", quantity: 0.5, unit: .none),
            Ingredient(name: "Unsalted butter, cut into pieces", quantity: 4, unit: .tablespoons),
    ...
    Recipe(mainInformation: MainInformation(name: "Chocolate Billionaires",
           ...
           ingredients: [
            ...
            Ingredient(name: "Water", quantity: 3, unit: .tablespoons),
            ...
            Ingredient(name: "Shortening", quantity: 1.25, unit: .teaspoons)
           ],
           directions:  [
    ...
    Recipe(mainInformation: MainInformation(name: "Mac & Cheese",
           ...
           ingredients: [
            ...
            Ingredient(name: "Butter, divided", quantity: 2, unit: .tablespoons),
            ...
            Ingredient(name: "Bay Leaves", quantity: 2, unit: .none),
            Ingredient(name: "Thyme", quantity: 0.5, unit: .teaspoons),
    ...
    Recipe(mainInformation: MainInformation(name: "White Clam Sauce",
           ...
           ingredients: [
            ...
            Ingredient(name: "White Wine", quantity: 2, unit: .tablespoons),
            Ingredient(name: "Butter", quantity: 4, unit: .tablespoons)
           ],
           directions:  [
    ...
    Recipe(mainInformation: MainInformation(name: "Granola Bowl",
           ...
           ingredients: [
            ...
            Ingredient(name: "Peanut Butter", quantity: 2, unit: .tablespoons),
           ],
           directions:  [
    ...
    Recipe(mainInformation: MainInformation(name: "Banana Bread",
           ...
           ingredients: [
            ...
            Ingredient(name: "Baking Soda", quantity: 1, unit: .teaspoons),
            Ingredient(name: "Salt", quantity: 1, unit: .teaspoons),
